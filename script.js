document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('click', function (e) {
    ...
    const navbarEl = document.querySelector('.navbar, [data-navbar], header');
  ...
  // ============================================================
  const navbar = document.querySelector('.navbar, [data-navbar], header');
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      if (field.type === 'submit' || field.type === 'button' ||
        field.type === 'reset' || field.type === 'hidden') {
        return;
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "כרמל-שוחטמן משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'e16943f2-7724-4cf5-92aa-7917b6786e5d',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'e16943f2-7724-4cf5-92aa-7917b6786e5d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e16943f2-7724-4cf5-92aa-7917b6786e5d';
